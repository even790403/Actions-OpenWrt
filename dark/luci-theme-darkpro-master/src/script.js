 ...
 *      https://github.com/apollo-ng/luci-theme-darkpro/issues
 *
 *  luci-theme-material
...
(function ($) {
    ...
    $(".main > .main-left > .nav > .slide > .menu").click(function () {
        ...
        if (!ul.is(":visible")) {
            ...
            ul.stop(true).slideUp(100, function () {
    ...
    $(".showSide").click(function () {
        if (showSide) {
            $(".darkMask").stop(true).fadeOut(100);
